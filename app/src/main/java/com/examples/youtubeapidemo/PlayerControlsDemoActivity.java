...
/**
 * A simple YouTube Android API demo application demonstrating the use of {@link YouTubePlayer} programmatic controls.
 */
public class PlayerControlsDemoActivity extends YouTubeFailureRecoveryActivity implements
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    videoChooser = findViewById(R.id.video_chooser);
