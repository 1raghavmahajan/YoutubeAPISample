...
/**
 * A simple YouTube Android API demo application which shows how to use a {@link YouTubeStandalonePlayer} intent to start a YouTube video playback.
 */
public class StandalonePlayerDemoActivity extends Activity implements View.OnClickListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    playVideoButton = findViewById(R.id.start_video_button);
    playPlaylistButton = findViewById(R.id.start_playlist_button);
    playVideoListButton = findViewById(R.id.start_video_list_button);
    startIndexEditText = findViewById(R.id.start_index_text);
    startTimeEditText = findViewById(R.id.start_time_text);
    autoplayCheckBox = findViewById(R.id.autoplay_checkbox);
    lightboxModeCheckBox = findViewById(R.id.lightbox_checkbox);
