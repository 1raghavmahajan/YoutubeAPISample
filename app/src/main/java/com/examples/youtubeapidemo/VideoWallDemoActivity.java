...
/**
 * A demo application aimed at showing the capabilities of the YouTube Player API.  It shows a video wall of flipping YouTube thumbnails.  Every 5
 * flips, one of the thumbnails will be replaced with a playing YouTube video.
 */
@TargetApi(11)
public class VideoWallDemoActivity extends Activity implements
  ...
  /**
   * An internal listener which listens to thumbnail loading events from the {@link YouTubeThumbnailView}.
   */
